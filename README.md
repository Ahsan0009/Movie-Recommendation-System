...
2. Install all the libraries mentioned in the [requirements.txt](https://github.com/Ahsan0009/Movie-Recommendation-System/requirements.txt) file with the command `pip install -r requirements.txt`.
